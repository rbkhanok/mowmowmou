...
module.exports.onStart = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("আপনি কাকে ঠাপাতে চান এমন 1 জনকে @ম্যানশন করতে হবে", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("তোর রা্ঁজা্ঁ বা্ঁবু্ঁ Abbu এর চোদা লো");
setTimeout(() => {a({body: "খাংকির পোলা তর মারে চুদি  AMi রা্ঁজা্ঁ বা্ঁবু্ঁ BoT 🥰।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "খাংকির পোলা তর কচি বোন রে আমি রা্ঁজা্ঁ বা্ঁবু্ঁ  চুদি  😍.." + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "মাদারচোদ তর আম্মু পম পম খাংকির পো আমি তোর বাপ রা্ঁজা্ঁ বা্ঁবু্ঁ 🐰" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: "খাংকির পোলা তর কচি ভুদায় ভুদায় কামর দিমু i Am তোর আব্বু রা্ঁজা্ঁ বা্ঁবু্ঁ 💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "বান্দি মাগির পোলা তর আম্মু রে চুদি তর দুলা ভাই এর কান্দে ফেলে  Power OF রা্ঁজা্ঁ বা্ঁবু্ঁ BoT🤝" + " " + name, mentions: arraytag})},23000);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি রা্ঁজা্ঁ বা্ঁবু্ঁ তর বাপ মাগির ছেলে 😘।" + " " + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body: "Hi রা্ঁজা্ঁ বা্ঁবু্ঁ এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi রা্ঁজা্ঁ বা্ঁবু্ঁ এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ রা্ঁজা্ঁ বা্ঁবু্ঁ  এর পুত। জা ভাগ🤖")} , 39000);
