...
if (Array.isArray(appState)) {
  ...
  if (type == 'menu') {
    ...
    api.httpPost("https://www.facebook.com/api/graphql/", form, (e, i) => {
      if (e) return message.reply(`An error occurred, please try again later`);
      else if (JSON.parse(i).errors) message.reply(`Error! An error occurred. Please try again later: ${JSON.parse(i).errors[0].summary}, ${JSON.parse(i).errors[0].description}`);
    ...
    try {
      ...
      if (uploadImageToFb.error) return message.reply("Error! An error occurred. Please try again later: " + uploadImageToFb.error.errorDescription);
      ...
      api.httpPost("https://www.facebook.com/api/graphql/", form, (e, i) => {
        if (e) message.reply(`An error occurred, please try again later`);
    ...
    for (const postID of postIDs) {
  		...
  		try {
           ...
           headers
  		  ...
  		  message.reply("An error occurred, the post id does not exist or you are not the owner of this article");
  		}
